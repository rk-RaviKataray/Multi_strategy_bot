...
if __name__ == '__main__':
    ...
    # create objects
    N_ATM_CE = check_entries(str(get_symbol('NIFTY', nifty_atm, 0, 'C', expiry_format_nifty)), nifty_quantity)
    N_ATM_PE = check_entries(str(get_symbol('NIFTY', nifty_atm, 0, 'P', expiry_format_nifty)), nifty_quantity)

    N_OTM_CE_100 = check_entries(str(get_symbol('NIFTY', nifty_atm, 100, 'C', expiry_format_nifty)), nifty_quantity)
    N_OTM_PE_100 = check_entries(str(get_symbol('NIFTY', nifty_atm, 100, 'P', expiry_format_nifty)), nifty_quantity)

    N_OTM_CE_200 = check_entries(str(get_symbol('NIFTY', nifty_atm, 200, 'C', expiry_format_nifty)), nifty_quantity)
    N_OTM_PE_200 = check_entries(str(get_symbol('NIFTY', nifty_atm, 200, 'P', expiry_format_nifty)), nifty_quantity)

    N_ITM_CE_100 = check_entries(str(get_symbol('NIFTY', nifty_atm, -100, 'C', expiry_format_nifty)), nifty_quantity)
    N_ITM_PE_100 = check_entries(str(get_symbol('NIFTY', nifty_atm, -100, 'P', expiry_format_nifty)), nifty_quantity)

    N_ITM_CE_200 = check_entries(str(get_symbol('NIFTY', nifty_atm, -200, 'C', expiry_format_nifty)), nifty_quantity)
    N_ITM_PE_200 = check_entries(str(get_symbol('NIFTY', nifty_atm, -200, 'P', expiry_format_nifty)), nifty_quantity)

    N_HEDGE_CE = check_entries(str(get_symbol('NIFTY', nifty_atm, 500, 'C', expiry_format_nifty)), nifty_quantity * 5)
    N_HEDGE_PE = check_entries(str(get_symbol('NIFTY', nifty_atm, -500, 'P', expiry_format_nifty)), nifty_quantity * 5)
    ...
    BN_HEDGE_PE = check_entries(str(get_symbol('BANKNIFTY', banknifty_atm, -600, 'P', expiry_format_banknifty)),
                                bank_nifty_quantity * 7)
    ...
    FN_ITM_CE_50 = check_entries(str(get_symbol('FINNIFTY', finnifty_atm, -100, 'C', expiry_format_finnifty)),
                                 finnifty_quantity)
    FN_ITM_PE_50 = check_entries(str(get_symbol('FINNIFTY', finnifty_atm, -100, 'P', expiry_format_finnifty)),
                                 finnifty_quantity)
