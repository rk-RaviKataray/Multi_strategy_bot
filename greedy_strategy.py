...
def create_N_call_objects_for_greedy_strategy():
    global greedy_strategy_N_call_obj_list
    greedy_strategy_N_call_obj_list = []
...
def create_N_put_objects_for_greedy_strategy():
    global greedy_strategy_N_put_obj_list
    greedy_strategy_N_put_obj_list = []
...
def create_BN_call_objects_for_greedy_strategy():
    global greedy_strategy_BN_call_obj_list
    greedy_strategy_BN_call_obj_list = []
...
def create_BN_put_objects_for_greedy_strategy():
    global greedy_strategy_BN_put_obj_list
    greedy_strategy_BN_put_obj_list = []
...
def create_FN_call_objects_for_greedy_strategy():
    global greedy_strategy_FN_call_obj_list
    greedy_strategy_FN_call_obj_list = []
...
def create_FN_put_objects_for_greedy_strategy():
    global greedy_strategy_FN_put_obj_list
    greedy_strategy_FN_put_obj_list = []
...
def execute_greedy_startegy():
    ...
    # create objects
    create_N_call_objects_for_greedy_strategy()
    create_N_put_objects_for_greedy_strategy()

    create_BN_call_objects_for_greedy_strategy()
    create_BN_put_objects_for_greedy_strategy()

    create_FN_call_objects_for_greedy_strategy()
    create_FN_put_objects_for_greedy_strategy()

    N_CALL_PROCESS = multi_processing.processing_multi(greedy_strategy_N_call_obj_list)
    N_PUT_PROCESS = multi_processing.processing_multi(greedy_strategy_N_put_obj_list)

    BN_CALL_PROCESS = multi_processing.processing_multi(greedy_strategy_BN_call_obj_list)
    BN_PUT_PROCESS = multi_processing.processing_multi(greedy_strategy_BN_put_obj_list)

    FN_CALL_PROCESS = multi_processing.processing_multi(greedy_strategy_FN_call_obj_list)
    FN_PUT_PROCESS = multi_processing.processing_multi(greedy_strategy_FN_put_obj_list)
...
class greed_strategy(threading.Thread):

    def __init__(self, symbol, quantity):
        super(greed_strategy, self).__init__()
